...
## <a name="attribute-classes"></a><span data-ttu-id="f29c7-109">Öznitelik sınıfları</span><span class="sxs-lookup"><span data-stu-id="f29c7-109">Attribute classes</span></span>
...
<span data-ttu-id="f29c7-127">adında çok kullanım özniteliği bir sınıf tanımlar `AuthorAttribute`.</span><span class="sxs-lookup"><span data-stu-id="f29c7-127">defines a multi-use attribute class named `AuthorAttribute`.</span></span> <span data-ttu-id="f29c7-128">Örnek</span><span class="sxs-lookup"><span data-stu-id="f29c7-128">The example</span></span>
...
### <a name="attribute-parameter-types"></a><span data-ttu-id="f29c7-144">Öznitelik parametre türleri</span><span class="sxs-lookup"><span data-stu-id="f29c7-144">Attribute parameter types</span></span>
...
## <a name="reserved-attributes"></a><span data-ttu-id="f29c7-253">Ayrılmış öznitelikleri</span><span class="sxs-lookup"><span data-stu-id="f29c7-253">Reserved attributes</span></span>
...
<span data-ttu-id="f29c7-271">Aşağıdaki sınırlamalara tabi buna koşullu bir yöntemdir:</span><span class="sxs-lookup"><span data-stu-id="f29c7-271">A conditional method is subject to the following restrictions:</span></span>
...
<span data-ttu-id="f29c7-311">Dosya `test.cs`:</span><span class="sxs-lookup"><span data-stu-id="f29c7-311">File `test.cs`:</span></span>
...
### <a name="caller-info-attributes"></a><span data-ttu-id="f29c7-324">Arayan bilgileri öznitelikleri</span><span class="sxs-lookup"><span data-stu-id="f29c7-324">Caller info attributes</span></span>
...
#### <a name="the-callermembername-attribute"></a><span data-ttu-id="f29c7-356">CallerMemberName özniteliği</span><span class="sxs-lookup"><span data-stu-id="f29c7-356">The CallerMemberName attribute</span></span>
...
<span data-ttu-id="f29c7-362">Dizin Oluşturucu erişimcileri içinde gerçekleşen çağrıları için kullanılan üye tarafından sağlanan addır bir `IndexerNameAttribute` ([IndexerName özniteliği](attributes.md#the-indexername-attribute)) varsa, dizin oluşturucu üye veya varsayılan adı `Item` Aksi takdirde.</span><span class="sxs-lookup"><span data-stu-id="f29c7-362">For invocations that occur within indexer accessors, the member name used is that supplied by an `IndexerNameAttribute` ([The IndexerName attribute](attributes.md#the-indexername-attribute)) on the indexer member, if present, or the default name `Item` otherwise.</span></span>

<span data-ttu-id="f29c7-363">Örnek oluşturucuları, statik Oluşturucular, Yıkıcılar ve işleçler bildirimlerinde, üye ortaya çağrıları için kullanılan ad uygulamaya bağlıdır.</span><span class="sxs-lookup"><span data-stu-id="f29c7-363">For invocations that occur within declarations of instance constructors, static constructors, destructors and operators the member name used is implementation-dependent.</span></span>

## <a name="attributes-for-interoperation"></a><span data-ttu-id="f29c7-364">Birlikte çalışma için öznitelikler</span><span class="sxs-lookup"><span data-stu-id="f29c7-364">Attributes for Interoperation</span></span>

<span data-ttu-id="f29c7-365">Not: Bu bölüm, yalnızca Microsoft .NET uygulaması için geçerlidir C#.</span><span class="sxs-lookup"><span data-stu-id="f29c7-365">Note: This section is applicable only to the Microsoft .NET implementation of C#.</span></span>

### <a name="interoperation-with-com-and-win32-components"></a><span data-ttu-id="f29c7-366">COM ve Win32 bileşenleri ile birlikte çalışma</span><span class="sxs-lookup"><span data-stu-id="f29c7-366">Interoperation with COM and Win32 components</span></span>

<span data-ttu-id="f29c7-367">.NET çalışma zamanı çok sayıda COM ve Win32 DLL'leri kullanılarak yazılmış bileşenler ile çalışmak C# programları etkinleştirme öznitelikleri sağlar.</span><span class="sxs-lookup"><span data-stu-id="f29c7-367">The .NET run-time provides a large number of attributes that enable C# programs to interoperate with components written using COM and Win32 DLLs.</span></span> <span data-ttu-id="f29c7-368">Örneğin, `DllImport` özniteliği kullanılabilir bir `static extern` bir Win32 DLL içinde bulunacak yöntemin uygulanmasını olduğunu belirtmek için yöntemi.</span><span class="sxs-lookup"><span data-stu-id="f29c7-368">For example, the `DllImport` attribute can be used on a `static extern` method to indicate that the implementation of the method is to be found in a Win32 DLL.</span></span> <span data-ttu-id="f29c7-369">Bu öznitelikler bulunan `System.Runtime.InteropServices` ad alanı ve bu öznitelikler için ayrıntılı belgelere .NET çalışma zamanı belgelerinde bulunabilir.</span><span class="sxs-lookup"><span data-stu-id="f29c7-369">These attributes are found in the `System.Runtime.InteropServices` namespace, and detailed documentation for these attributes is found in the .NET runtime documentation.</span></span>

### <a name="interoperation-with-other-net-languages"></a><span data-ttu-id="f29c7-370">Diğer .NET dilleri ile birlikte çalışma</span><span class="sxs-lookup"><span data-stu-id="f29c7-370">Interoperation with other .NET languages</span></span>

#### <a name="the-indexername-attribute"></a><span data-ttu-id="f29c7-371">IndexerName özniteliği</span><span class="sxs-lookup"><span data-stu-id="f29c7-371">The IndexerName attribute</span></span>

<span data-ttu-id="f29c7-372">Dizin oluşturucular dizinli özellikler kullanılarak. NET'te uygulanır ve .NET meta verilerde bir ada sahip.</span><span class="sxs-lookup"><span data-stu-id="f29c7-372">Indexers are implemented in .NET using indexed properties, and have a name in the .NET metadata.</span></span> <span data-ttu-id="f29c7-373">Hayır ise `IndexerName` özniteliktir bir dizin oluşturucu ve ardından adı için mevcut `Item` varsayılan olarak kullanılır.</span><span class="sxs-lookup"><span data-stu-id="f29c7-373">If no `IndexerName` attribute is present for an indexer, then the name `Item` is used by default.</span></span> <span data-ttu-id="f29c7-374">`IndexerName` Özniteliği sağlayan bir geliştirici bu varsayılanı geçersiz kılmak ve farklı bir ad belirtin.</span><span class="sxs-lookup"><span data-stu-id="f29c7-374">The `IndexerName` attribute enables a developer to override this default and specify a different name.</span></span>
